...
writeToFiles <- function (latexFile, htmlFile, descriptorName) {
    imagesRow <- c("<div class=\"row\">",
            ...
            "<div class=\"row\">",
            "    <div class=\"col-lg-2\">",
            paste("        <a href=\"../training/all/", descriptorName, "\">", sep=""),
            paste("        <img class=\"img-thumbnail\" src=\"../training/all/", descriptorName, "\">", sep=""),
            "        </a>",
            "    </div>",
            "    <div class=\"col-lg-2\">",
            paste("        <a href=\"../training/positives/", descriptorName, "\">", sep=""),
            paste("        <img class=\"img-thumbnail\" src=\"../training/positives/", descriptorName, "\">", sep=""),
            "        </a>",
            "    </div>",
            "    <div class=\"col-lg-2\">",
            paste("        <a href=\"../training/negatives/", descriptorName, "\">", sep=""),
            paste("        <img class=\"img-thumbnail\" src=\"../training/negatives/", descriptorName, "\">", sep=""),
            "        </a>",
            "    </div>",
            "",
            "    <div class=\"col-lg-2\">",
            paste("        <a href=\"../test/all/", descriptorName, "\">", sep=""),
            paste("        <img class=\"img-thumbnail\" src=\"../test/all/", descriptorName, "\">", sep=""),
            "        </a>",
            "    </div>",
            "    <div class=\"col-lg-2\">",
            paste("        <a href=\"../test/positives/", descriptorName, "\">", sep=""),
            paste("        <img class=\"img-thumbnail\" src=\"../test/positives/", descriptorName, "\">", sep=""),
            "        </a>",
            "    </div>",
            "    <div class=\"col-lg-2\">",
            paste("        <a href=\"../test/negatives/", descriptorName, "\">", sep=""),
            paste("        <img class=\"img-thumbnail\" src=\"../test/negatives/", descriptorName, "\">", sep=""),
            "        </a>",
            "    </div>",
            "</div>"
        )
