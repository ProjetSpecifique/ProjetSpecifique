...
public class HoughTransform extends Thread{
	public static void main(String[] args) throws Exception {
		String filename = "src/vonal.png";

		// load the file using Java's imageIO library
		BufferedImage image = javax.imageio.ImageIO.read(new File(filename));
		
		ImagePlus imagePlus2 = new ImagePlus("First Image", image);
		ImageProcessor imp = imagePlus2.getProcessor();
		//imp.drawLine(83, 1178, 86, 1279);
		//imp.drawLine(0, 0, 1917, 1279);
		imagePlus2.show();
		...
		for (int j = 0; j < lines.size(); j++) {
			...
			imp = line.draw(image, Color.RED.getRGB(),imp);
		}
